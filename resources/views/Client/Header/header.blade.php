 ...
 <div class="row">
  <div class="col-12">
   <nav class="navbar navbar-expand-lg navbar-light bg-light rounded" style="background-color:#FDCE06 !important">
       ...
       <div class="dropdown-menu megamenu" aria-labelledby="dropdown01">
        <div class="row">
         ...
         <div class="col-sm-6 col-lg-3">
          <h4 class="dropdown-header"><a href="" style="color:#e74c3c"></a></h4>
          
          <a class="dropdown-item ml-3" href=""></a>
       ...
       <div class="dropdown-menu megamenu" aria-labelledby="dropdown01">
        <div class="row">
         ...
         <div class="col-sm-6 col-lg-3">
           ...
           <h4 class="dropdown-header"><a href="" style="color:#e74c3c">All Orders</a></h4>
	...
	<a class="nav-item" href="/5555">Contact Us</a>
    </div>
   </nav>
  </div>
 </div>
