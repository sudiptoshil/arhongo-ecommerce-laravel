        ...
        <div class="col-md-6 offset-md-3">
          ...
          <form action="{{route('update-category')}}" method="Post"  enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <input id="category_name" name="category_name" class="form-control form-control-lg" type="text" placeholder="" value="{{$category->category_name}}" required
              style="border-radius: 20px;">
              <input id="category_name" name="id" class="form-control form-control-lg" type="hidden" placeholder="" value="{{$category->id}}" required
              style="border-radius: 20px;">
            </div>
            ...
            <!-- <div class="form-check">
              <input type="checkbox" name="home_page" value="1"  'checked':'' ?> class="form-check-input" id="exampleCheck1">
              <label class="form-check-label" for="exampleCheck1">Display On Home Page</label>
            </div> -->

            <div class="form-check">
            <label class="form-check-label">
              <input type="radio" class="form-check-input" value='1' {{$category->publication_status == 1 ? "" : "checked" }} name="publication_status" >published
            </label>
          </div>
          <div class="form-check">
            <label class="form-check-label">
              <input type="radio" class="form-check-input" value='0' {{$category->publication_status == 0 ? "" : "checked" }}  name="publication_status">unpublished
            </label>
          </div>
