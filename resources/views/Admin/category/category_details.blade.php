...
<div class="pl-5 pr-5 pt-3">
  ...
  <div class="text-center">
    ...
    <a href="{{route('edit-category',['id' => $category->id])}}" class="btn btn-sm btn-outline-warning" style="border-radius: 18px;"><i class="fas fa-edit">{{{$category->category_name}}}</i></a>
    @foreach ($subcategories as $v_subcategories)
