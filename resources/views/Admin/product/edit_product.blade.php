    ...
    <div id="content-wrapper">
      <div class="container-fluid">
        ...
        <div class="card mb-3">
          ...
          <div class="card-body">
            <form class="form-group" action="{{route('update-product')}}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="form-row">
                    ...
                    <div class="col">
                        <label for="vendor_id">Select Vendor</label>    
                            <select name="vendor_id" class="form-control" id="vendor_id" onchange="getBrands(this.value)">
                                ...
                                <option value="{{$v_vendors->id}}">{{$v_vendors->username}}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="col">
                        ...
                        <textarea required type="text" class="form-control" name="product_description" id="product_description">{{$product->product_name}}</textarea>
                        <small class="text-danger"></small>
                    </div>
                </div>
