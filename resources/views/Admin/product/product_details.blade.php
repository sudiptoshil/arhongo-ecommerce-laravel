      ...
      <div class="container-fluid">
        <div class="pl-5 pr-5 pt-3">
            ...
            <div class="text-center">
                <a href="{{route('edit-product',['id' => $products->id])}}" class="btn btn-sm btn-outline-warning" style="border-radius: 18px;"><i class="fas fa-edit"></i></a>
            </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <!-- Product Details -->
                    <h6>Name: <strong>{{$products->product_name}}</strong></h6>
                    @if($products->category)
                    <h6>Category: <strong>{{$products->category->category_name}}</strong></h6>
                    @else
                    <td> category not found</td>
                    @endif
                    <h6>
                        Total Quantity: <strong>{{$products->product_quantity}} {{$products->sell_unit}}</strong>
                    ...
                    <h6>Price: <strong>{{$products->display_price}}</strong></h6>
                    @if($products->type)
                    <h6>type: <strong>{{$products->type->type_name}}</strong></h6>
                    @else 
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 col-md-4">
                                <a class="lightbox" href="">
                                    @if($products->img)
                                    <img src="{{asset($products->img)}}" alt="Sky">
                                    @else
                             ...
                             @foreach($pro_img as $v_img)
                             <div class="col-sm-6 col-md-4">
                                <a class="lightbox" href="">
                                    
                                    <img src="{{asset($v_img->image_url)}}" alt="Sky">
  ...
  <a class="scroll-to-top rounded" href="#page-top">
    ...
    <div class="modal fade" id="addImageModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            ...
            <form class="form-group" action="{{route('add-more-image')}}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="modal-body">
                        ...
                        <div class="">
                            <div class="text-center">
                                ...
                                <input required id="file-upload" style="display: none" type="file" name="image_url"/>
    ...
    <div class="modal fade" id="addSizeColor" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            ...
            <div class="modal-body">
                <form class="form-group" action="{{route('add-color-size')}}" method="POST">
                    @csrf
                    <input type="hidden" name="product_id" value="{{$products->id}}">
                    <div class="form-row">
                        Size <br>
